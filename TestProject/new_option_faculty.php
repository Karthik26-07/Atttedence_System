    ...
    <body>
        ...
        <form class="card stu my-5  shadow-lg p-3 bg-white rounded " method="post" action="" >
            ...
            <div class="form-group ">
                ...
                Subject  Name: <select class="" name="selectnameid" id='selectnameid'  onchange="myfunction(this.value)"selected="selected">
       ...
       <form class="my-5">
        ...
        <script>
                    function myfunction(subname) {
                            ...
                            $.ajax({
                                type: "GET",
                                url: "Attedencepage.php",
                                data: {name: subname}, //sending the data to the displayStudent.php
